...
namespace DMBEffectBuilder
{
    ...
    ///     Chain <see cref="SetOverlay" /> to darken the video, then <see cref="VideoSectionHeader" /> to add a title block on
    ///     top.
    /// </summary>
    [Documented]
    public sealed class VideoSectionEffectBuilder : HtmlTagBuilder<VideoSectionEffectBuilder>, IDisposable, ICanUseHeight, ICanUseCustomClasses, ICanUseMargin
    {
        ...
        /// <summary>
        ///     Adds a semi-transparent dark overlay between the video background and the title content to improve text
        ///     legibility.
        /// </summary>
        /// <returns>The current builder instance for chaining.</returns>
        /// <remarks>
        ///     <para>
        ///         <b>Use cases:</b> use whenever the video is bright, colourful, or visually busy and white/light-coloured
        ///         title text would be hard to read without a darkening layer.
        ///     </para>
        ///     <para>
        ///         <b>How it works:</b> sets an internal flag that causes <c>Begin</c> to render the header inside a
        ///         <c>.eb-video-section-overlay</c> div, which the stylesheet styles with a semi-transparent dark background
        ///         positioned over the video element.
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> call before <see cref="Begin" /> — the flag is read at render time and has no effect
        ///         afterwards. Works alongside <see cref="VideoSectionHeader" /> regardless of call order.
        ///     </para>
        ///     <para>
        ///         <b>Tips:</b> the overlay opacity is controlled by the stylesheet; if the default darkening is too heavy or
        ///         too light, override <c>.eb-video-section-overlay</c> in a custom CSS file rather than duplicating the builder.
        ///     </para>
        ///     <para>
        ///         <b>Example:</b>
        ///         <code>
        ...
        /// <returns>
        ///     A <see cref="VideoSectionEffectHeader" /> for configuring the title, subtitle, and optional call-to-action
        ///     button.
        /// </returns>
        /// <remarks>
        ///     <para>
        ///         <b>Use cases:</b> call whenever the video section needs a visible text header — a main title, an optional
        ///         subtitle, and an optional button to drive user action.
        ///     </para>
        ///     <para>
        ///         <b>How it works:</b> returns a new <see cref="VideoSectionEffectHeader" /> instance; calling <c>Build()</c>
        ///         on it serialises the header HTML and registers it on this builder via <c>WriteHeader</c>. On
        ///         <see cref="Begin" />, the header is emitted either before the body div or inside an overlay wrapper depending
        ///         on <see cref="SetOverlay" />.
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> configure <see cref="SetOverlay" /> before <see cref="Begin" /> to control header
        ///         placement; chain <c>SetSubtitle</c> and <c>SetButton</c> on the title builder before calling <c>Build()</c> to
        ///         return here.
        ///     </para>
        ///     <para>
        ///         <b>Tips:</b> the title builder is single-use — a second call replaces the previously registered header;
        ///         complete the entire chain in one go.
        ///     </para>
        ///     <para>
        ///         <b>Example:</b>
        ///         <code>
