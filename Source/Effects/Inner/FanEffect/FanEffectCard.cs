...
namespace DMBEffectBuilder
{
    ...
    public sealed class FanEffectCard
    {
        ...
        )
        {
            ...
            if (subtitle != null) sb.Append($"""<h6 class="fw-normal small text-muted mb-0">{enc.Encode(subtitle)}</h6>""");
            sb.Append("</div>");
        ...
        /// <summary>
        ///     Creates a card with a Razor template delegate as content and no background image — the preferred overload in
        ///     <c>.cshtml</c> views.
        /// </summary>
        ...
        /// <summary>
        ///     Creates a card with a background image and a Razor template delegate rendered on top — the preferred overload
        ///     in <c>.cshtml</c> views.
        /// </summary>
        /// <param name="src">Image URL used as the card background.</param>
