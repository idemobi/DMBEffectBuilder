...
namespace DMBEffectBuilder
{
    ...
    public sealed class FanEffectBuilder : IHtmlContent
    {
        ...
        ///     <para>
        ///         <b>How it works:</b> appends the card to the internal list; rotation and position are computed at render time
        ///         based on the total card count.
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> use together with <see cref="AddCards" /> freely — both append to the same list. Call
        ///         before <see cref="SetEntrance" /> so entrance stagger indices are correct.
        ///     </para>
        ...
        ///     <para>
        ///         <b>How it works:</b> delegates to <c>List.AddRange</c> — identical to calling <see cref="AddCard" /> for each
        ///         element in order.
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> can be mixed with <see cref="AddCard" />; all cards share the same spread geometry
        ///         regardless of how they were added.
        ///     </para>
        ///     <para>
        ///         <b>Tips:</b> prefer this over multiple <see cref="AddCard" /> calls when cards are already in an array for
        ...
        /// <remarks>
        ///     <para>
        ///         <b>Use cases:</b> use when cards at steep rotation angles are clipped by the container edge and need to be
        ///         lifted higher.
        ///     </para>
        ///     <para>
        ///         <b>How it works:</b> sets the <c>--eb-fan-bottom</c> CSS custom property, which shifts the pivot point upward
        ///         so that the card corners stay within the container bounds.
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> the minimum safe value for a given spread is approximately
        ///         <c>(cardWidth / 2) × sin(maxAngle)</c>; recalculate after changing <see cref="SetCardSize" /> or
        ///         <see cref="SetSpreadByWidth" />.
        ///     </para>
        ///     <para>
        ///         <b>Tips:</b> start with the default 20 px and increase only when clipping is visible; a large offset wastes
        ///         vertical space at the bottom.
        ///     </para>
        ///     <para>
        ///         <b>Example:</b>
        ///         <code>
        ...
        /// <remarks>
        ///     <para>
        ///         <b>Use cases:</b> when the default 200 × 280 cards need to match a specific image aspect ratio or fit inside
        ///         a constrained layout.
        ///     </para>
        ///     <para>
        ///         <b>How it works:</b> writes <c>--eb-fan-card-w</c> and <c>--eb-fan-card-h</c> CSS custom properties on the
        ///         container; the spread angle calculation also uses <paramref name="heightPx" /> as the lever arm.
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> always call before <see cref="SetSpreadByWidth" /> when the spread geometry depends on
        ///         card height; update <see cref="SetContainerHeight" /> and <see cref="SetBottomOffset" /> to match taller or
        ///         shorter cards.
        ///     </para>
        ///     <para>
        ///         <b>Tips:</b> portrait orientation (height &gt; width) gives the most realistic hand-of-cards appearance;
        ///         square or landscape cards look more like a spread of tiles.
        ///     </para>
        ///     <para>
        ///         <b>Example:</b>
        ///         <code>
        ...
        /// <remarks>
        ///     <para>
        ///         <b>Use cases:</b> adjust when the default 360 px container is too tall for a compact section or too short to
        ///         show taller cards without clipping.
        ///     </para>
        ///     <para>
        ///         <b>How it works:</b> writes <c>--eb-fan-h</c> CSS custom property on the container div, which drives the
        ///         overall height of the fan widget.
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> set this in tandem with <see cref="SetCardSize" /> — a good starting point is card
        ///         height plus the bottom offset plus a few pixels of breathing room.
        ///     </para>
        ///     <para>
        ///         <b>Tips:</b> if hovering a card causes it to overflow the container, increase this value or reduce the card
        ///         height.
        ///     </para>
        ///     <para>
        ///         <b>Example:</b>
        ...
        ///     The direction cards slide in from. Use <see cref="FanEffectEntranceDirection.None" /> to
        ///     disable the animation.
        /// </param>
        /// <param name="delayStepMs">
        ///     Milliseconds between each successive card animation start. Default: <c>80</c>. Clamped to a
        ///     minimum of 0.
        /// </param>
        /// <returns>The current builder instance for chaining.</returns>
        /// <remarks>
        ///     <para>
        ///         <b>Use cases:</b> adds visual polish on page load or scroll; a left/right entrance direction reinforces the
        ///         card-dealing metaphor.
        ///     </para>
        ///     <para>
        ///         <b>How it works:</b> sets the <c>data-entrance</c> attribute on the container and a <c>--eb-fan-delay</c> CSS
        ///         custom property on each card with a cumulative offset; the JS observer triggers the animation on intersection.
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> works independently of <see cref="SetSpreadByWidth" /> and <see cref="SetCardSize" />;
        ///         call after adding all cards so the stagger indices match the final card order.
        ///     </para>
        ///     <para>
        ///         <b>Tips:</b> 60–100 ms per step feels natural for 3–6 cards; reduce the step for larger fans to avoid a long
        ///         wait for the last card; set <paramref name="delayStepMs" /> to 0 for a simultaneous entrance.
        ///     </para>
        ///     <para>
        ///         <b>Example:</b>
        ///         <code>
        ...
        /// <summary>
        ///     Controls the fan spread shape by specifying the total horizontal width occupied by cards at their top and
        ///     bottom edges.
        /// </summary>
        /// <param name="topWidthPx">Total horizontal span of all card tops in pixels. Default: <c>150</c>.</param>
        /// <param name="bottomWidthPx">
        ///     Total horizontal span of all card bottoms in pixels. Default: <c>0</c> (converging at a
        ///     single anchor point).
        /// </param>
        /// <returns>The current builder instance for chaining.</returns>
        /// <remarks>
        ///     <para>
        ///         <b>Use cases:</b> the primary control for shaping the fan — use a large top width and zero bottom width for a
        ///         dramatic hand-of-cards look, or equal values for a flat tiled row.
        ///     </para>
        ///     <para>
        ///         <b>How it works:</b> for each card the builder computes the horizontal position at top and bottom using
        ///         linear interpolation across the spread, then derives the rotation angle via <c>arcsin(deltaX / cardHeight)</c>.
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> recalculate <see cref="SetBottomOffset" /> when increasing spread to avoid clipping
        ///         rotated corners; pair with <see cref="SetContainerHeight" /> to give enough vertical room.
        ///     </para>
        ///     <para>
        ///         <b>Tips:</b> <paramref name="topWidthPx" /> = card count × card width produces a barely-overlapping flat fan;
        ///         half that value gives moderate overlap; setting <paramref name="bottomWidthPx" /> &gt; 0 opens the bottom and
        ...
        public void WriteTo(TextWriter writer, HtmlEncoder encoder)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (_entranceDirection != FanEffectEntranceDirection.None) cardStyle += $"--eb-fan-delay:{i * _entranceDelayStepMs}ms;";
