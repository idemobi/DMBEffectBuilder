...
namespace DMBEffectBuilder
{
    ...
    public static class GlowHoverEffect_ImageExtension
    {
        ...
        /// <param name="color">
        ///     The RGBA color of the glow. Defaults to a semi-transparent Bootstrap primary blue (
        ///     <c>rgba(64,13,110,253)</c>).
        /// </param>
        ...
        /// <remarks>
        ///     <para>
        ///         <b>Use cases:</b> Card thumbnails, clickable gallery images, profile avatars, and any interactive image that
        ///         benefits from a visual hover cue without JavaScript.
        ///     </para>
        ///     <para>
        ///         <b>How it works:</b> Sets CSS variables <c>--eb-image-effect-glow-color</c> and
        ///         <c>--eb-image-effect-glow-size</c> on the image element, then adds the class <c>eb-image-effect-glow-hover</c>
        ///         to its media wrapper via <c>GlowHoverEffect.css</c>. The CSS applies a <c>box-shadow</c> transition on
        ///         <c>:hover</c> to produce the glow.
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> Works well alongside <c>LiftHoverEffect</c> — the lift physically separates the image
        ///         while the glow frames it. Avoid stacking with <c>NeonFrameEffect</c>: both effects compete for the outer-border
        ///         space and the two <c>box-shadow</c> values clash visually.
        ///     </para>
        ///     <para>
        ///         <b>Tips:</b> Use an alpha value below 160 for the glow color to keep it soft; a fully opaque color looks
        ///         harsh. For branding, pass a tinted variant of your primary accent color. Sizes between 20–40 px feel natural;
        ///         above 60 px the glow bleeds into adjacent elements — add layout margin to compensate.
        ///     </para>
        ///     <para>
        ///         <b>Example:</b>
        ///         <code>
