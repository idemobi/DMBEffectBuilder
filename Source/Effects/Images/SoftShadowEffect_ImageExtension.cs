...
namespace DMBEffectBuilder
{
    ...
    public static class SoftShadowEffect_ImageExtension
    {
        ...
        /// <param name="color">
        ///     Shadow color; defaults to <c>rgba(0,0,0,0.15)</c> — a very light black shadow. Use a colored shadow
        ///     to match the image's dominant hue for a natural glow.
        /// </param>
        ...
        /// <remarks>
        ///     <para>
        ///         <b>Use cases:</b> Cards, thumbnails, product photos, avatars — any image that should feel lifted off the
        ///         page. Especially effective on images with white or transparent backgrounds where the shadow separates the
        ///         subject from the layout.
        ///     </para>
        ///     <para>
        ///         <b>How it works:</b> Sets CSS variables <c>--eb-image-effect-color</c> (RGBA), <c>--eb-image-effect-blur</c>,
        ///         and <c>--eb-image-effect-offset-y</c> on the image element, then wraps it in a media component with class
        ///         <c>eb-image-effect-soft-shadow</c> (SoftShadowEffect.css). Implemented via CSS <c>filter: drop-shadow()</c>,
        ///         which respects transparent PNG edges rather than boxing them.
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> Excellent baseline to combine with almost any other effect — <c>ZoomHoverEffect</c>,
        ///         <c>RotateSlightlyEffect</c>, <c>ShineSweepEffect</c>. For a photo-print look, combine with
        ///         <c>RotateRandomEffect</c>. The shadow makes the lift feel real.
        ///     </para>
        ///     <para>
        ///         <b>Tips:</b> Default values are deliberately subtle — increase <c>blur</c> to 50–80 and <c>offsetY</c> to
        ///         16–20 for a more theatrical floating effect. For a colored ambient shadow matching an image, sample the
        ///         dominant hue: <c>Color.FromArgb(60, 200, 100, 50)</c>. Avoid very opaque shadows (alpha > 100) — they look
        ///         painted-on.
        ///     </para>
        ///     <para>
        ///         <b>Example:</b>
        ...
        /// </remarks>
        [Documented]
        public static ImageRenderBuilder SoftShadowEffect(
            this ImageRenderBuilder builder,
            Color? color = null,
            int blur = 30,
            UnitSize blurUnit = UnitSize.px,
            int offsetY = 8,
            UnitSize offsetYUnit = UnitSize.px
        )
        {
