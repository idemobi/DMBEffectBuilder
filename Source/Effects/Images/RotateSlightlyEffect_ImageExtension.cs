...
namespace DMBEffectBuilder
{
    ...
    public static class RotateSlightlyEffect_ImageExtension
    {
        ...
        /// <summary>
        ///     Applies a fixed, subtle tilt to the image, giving it a relaxed, hand-placed appearance at rest and optionally
        ///     correcting on hover.
        /// </summary>
        ...
        /// <remarks>
        ///     <para>
        ///         <b>Use cases:</b> Decorative images in blog posts, profile pictures with a casual tone, card-style UI
        ///         elements, or anywhere a perfectly straight image would feel too rigid. Unlike <c>RotateRandomEffect</c>, the
        ///         angle is deterministic — every page load looks identical, which is better for design consistency.
        ///     </para>
        ///     <para>
        ///         <b>How it works:</b> Writes CSS variables <c>--eb-image-effect-deg</c>, <c>--eb-image-effect-hover-deg</c>,
        ///         <c>--eb-image-effect-scale</c>, and <c>--eb-image-effect-hover-scale</c> directly on the image element, then
        ///         wraps it in a component with class <c>eb-image-effect-rotate-slightly</c> (RotateSlightlyEffect.css).
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> Works very well with <c>SoftShadowEffect</c> to simulate a physical print. Can be
        ///         layered with <c>VignetteEffect</c> for a vintage photograph feel. Avoid combining with <c>RotateEffect</c> or
        ///         <c>RotateRandomEffect</c>.
        ///     </para>
        ///     <para>
        ///         <b>Tips:</b> Stay within ±6 degrees for a natural look; beyond that the tilt reads as a deliberate design
        ///         choice rather than a subtle accent. Use <c>hoverDeg: 0, hoverScale: 1.05</c> to create a "pick up the photo"
        ///         hover interaction. A positive <c>deg</c> leans right, negative leans left — mix both in a grid for visual
        ///         rhythm.
        ///     </para>
        ///     <para>
        ///         <b>Example:</b>
