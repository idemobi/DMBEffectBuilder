...
namespace DMBEffectBuilder
{
    ...
    public static class LockedRevealEffect_ImageExtension
    {
        ...
        /// <summary>
        ///     Covers the image with a dark overlay showing a lock icon, then reveals the image with an unlock animation on
        ///     hover.
        /// </summary>
        /// <param name="builder">The <see cref="ImageRenderBuilder" /> to apply the effect to.</param>
        /// <param name="lockCharacter">
        ///     The character or emoji rendered as the lock icon in the center of the overlay. Default is
        ///     <c>"🔒"</c>.
        /// </param>
        ...
        ///     The background color of the overlay that hides the image. Defaults to near-opaque black (
        ///     <c>rgba(0,0,0,0.99)</c>).
        /// </param>
        /// <returns>The modified <see cref="ImageRenderBuilder" /> instance with the effect applied.</returns>
        /// <remarks>
        ///     <para>
        ///         <b>Use cases:</b> Premium or members-only content previews, gated gallery images, spoiler images on game or
        ///         media sites, and any image where you want to tease the content while clearly communicating that access is
        ///         restricted.
        ///     </para>
        ///     <para>
        ///         <b>How it works:</b> Sets CSS variables <c>--eb-image-effect-lock</c>, <c>--eb-image-effect-size</c>,
        ///         <c>--eb-image-effect-color</c>, and <c>--eb-image-effect-overlay-color</c>, then wraps the image in a wrapper
        ///         component (not a media component) with the class <c>eb-image-effect-locked-reveal</c> via
        ///         <c>LockedRevealEffect.css</c>. On hover, the overlay fades out and the lock icon animates to an unlocked state,
        ///         revealing the image beneath.
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> Works standalone — adding hover effects like <c>GlowHoverEffect</c> beneath this is
        ///         pointless since the image is hidden at rest. Once you have the reveal pattern, consider pairing with
        ///         <c>KenBurnsSlowEffect</c> so the revealed image immediately feels alive.
        ///     </para>
        ///     <para>
        ///         <b>Tips:</b> The default near-opaque black overlay guarantees the image is completely hidden; if you want a
        ///         subtle tease of the image through a translucent overlay, reduce the alpha of <paramref name="overlayColor" />
        ///         to around 200–220. Choose a <paramref name="lockCharacter" /> that fits your content's tone — a key emoji (
        ///         <c>"🗝"</c>) works well for vintage or treasure themes, while a simple Unicode lock (<c>"🔐"</c>) suits
        ///         corporate UIs. Ensure the container has a fixed height so the overlay covers the full image area.
        ///     </para>
        ///     <para>
        ///         <b>Example:</b>
        ///         <code>
