...
namespace DMBEffectBuilder
{
    ...
    public static class PolaroidEffect_ImageExtension
    {
        ...
        /// <summary>
        ///     Styles the image as a Polaroid photograph with a white frame, thicker bottom border, subtle shadow, and a
        ///     slight rotation.
        /// </summary>
        /// <param name="builder">The <see cref="ImageRenderBuilder" /> to apply the effect to.</param>
        /// <param name="padding">
        ///     Uniform padding applied to all four sides of the Polaroid frame, in <paramref name="unit" />.
        ///     Default is 10.
        /// </param>
        /// <param name="unit">
        ///     The unit of measurement for both <paramref name="padding" /> and <paramref name="bottomPadding" />.
        ///     Default is <see cref="UnitSize.px" />.
        /// </param>
        /// <param name="bottomPadding">
        ///     Extra padding on the bottom edge that creates the characteristic wide Polaroid tab. Default
        ///     is 26.
        /// </param>
        /// <param name="backgroundColor">The fill color of the Polaroid frame. Defaults to white (<c>Color.White</c>).</param>
        /// <param name="borderColor">
        ///     The color of the thin border around the frame. Defaults to a very light transparent black (
        ///     <c>rgba(0,0,0,0.08)</c>).
        /// </param>
        /// <param name="shadowColor">
        ///     The color of the drop shadow cast by the frame. Defaults to a soft transparent black (
        ///     <c>rgba(0,0,0,0.18)</c>).
        /// </param>
        /// <returns>The modified <see cref="ImageRenderBuilder" /> instance with the effect applied.</returns>
        /// <remarks>
        ///     <para>
        ///         <b>Use cases:</b> Photography portfolios, nostalgic or vintage-themed galleries, travel blogs, testimonial
        ///         sections with portrait photos, and any layout where an informal, handcrafted feel is desirable. Works best when
        ///         several polaroid images are placed in a scattered or slightly rotated grid.
        ///     </para>
        ///     <para>
        ///         <b>How it works:</b> Sets CSS variables <c>--eb-image-effect-padding</c>,
        ///         <c>--eb-image-effect-bottom-padding</c>, <c>--eb-image-effect-bg-color</c>,
        ///         <c>--eb-image-effect-border-color</c>, and <c>--eb-image-effect-shadow-color</c>, then adds the class
        ///         <c>eb-image-effect-polaroid</c> to the media wrapper via <c>PolaroidEffect.css</c>. The CSS applies
        ///         <c>padding</c>, <c>border</c>, <c>box-shadow</c>, and a slight <c>rotate</c> transform to the wrapper.
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> Combine with <c>LiftHoverEffect</c> to make individual polaroids lift on hover — this is
        ///         particularly effective in a scattered grid. Avoid using with <c>NeonFrameEffect</c> or <c>GlowHoverEffect</c>,
        ///         which clash with the delicate paper frame aesthetic.
        ///     </para>
        ///     <para>
        ///         <b>Tips:</b> Set a fixed image size before calling this method — the Polaroid frame adds
        ///         <paramref name="padding" /> and <paramref name="bottomPadding" /> around the image, so the overall rendered
        ///         size is larger than the image dimensions. Increase <paramref name="bottomPadding" /> to 40–50 px if you plan to
        ///         overlay a caption inside the tab area via CSS. For a stack-of-photos look, apply alternating small positive and
        ///         negative CSS <c>rotate</c> values to sibling wrappers manually.
        ///     </para>
        ///     <para>
        ///         <b>Example:</b>
        ///         <code>
