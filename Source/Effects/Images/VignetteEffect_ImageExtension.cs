...
namespace DMBEffectBuilder
{
    ...
    public static class VignetteEffect_ImageExtension
    {
        ...
        /// <param name="color">
        ///     Color of the vignette overlay; defaults to <c>rgba(0,0,0,0.45)</c> — a mid-strength black border.
        ///     Use a colored value for creative tinting.
        /// </param>
        /// <param name="opacity">
        ///     Opacity of the vignette overlay (default 1.0 — fully visible). Lower values reduce the effect
        ///     without changing its color.
        /// </param>
        /// <param name="innerSize">
        ///     Diameter of the clear central area as a percentage of the element (default 55%; larger values
        ///     push the dark edges further out).
        /// </param>
        ...
        /// <remarks>
        ///     <para>
        ///         <b>Use cases:</b> Vintage or cinematic photography, hero banners, atmospheric game-UI images, profile
        ///         portraits where the subject is centered. Any image where you want to draw the eye inward and de-emphasize the
        ///         periphery.
        ///     </para>
        ///     <para>
        ///         <b>How it works:</b> Sets CSS variables <c>--eb-image-effect-color</c> (RGBA),
        ///         <c>--eb-image-effect-opacity</c>, and <c>--eb-image-effect-size</c> on the image element, then wraps it in a
        ///         media component with class <c>eb-image-effect-vignette</c> (VignetteEffect.css). The vignette is rendered as a
        ///         CSS radial-gradient pseudo-element positioned over the image.
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> Pairs naturally with <c>SepiaEffect</c> for a period-photograph look. Combine with
        ///         <c>ZoomHoverEffect</c> so the vignette intensifies as the image zooms — the shrinking field of view reinforces
        ///         depth. Avoid with <c>ShineSweepEffect</c> — the bright sweep fights the dark border.
        ///     </para>
        ///     <para>
        ///         <b>Tips:</b> Increase <c>innerSize</c> to 70–80% for a barely-there edge treatment that adds mood without
        ///         dominating. Lower it to 30–40% for a dramatic, tunnel-like vignette. To create a colored vignette (warm amber,
        ///         deep teal), set <c>color</c> with a partially transparent hue and keep <c>opacity</c> at 1.0. Combining a
        ///         reduced <c>opacity</c> with a small <c>innerSize</c> avoids over-darkening while still shaping the composition.
        ///     </para>
        ///     <para>
        ///         <b>Example:</b>
        ///         <code>
