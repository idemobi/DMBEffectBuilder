...
namespace DMBEffectBuilder
{
    ...
    public static class GlitchEffect_ImageExtension
    {
        ...
        /// <summary>
        ///     Applies a looping glitch animation with RGB channel splitting and horizontal displacement to the image,
        ///     simulating a digital signal distortion.
        /// </summary>
        ...
        /// <param name="unit">
        ///     The unit of measurement for the <paramref name="size" /> value. Defaults to
        ///     <see cref="UnitSize.px" />.
        /// </param>
        /// <returns>The modified <see cref="ImageRenderBuilder" /> instance with the effect applied.</returns>
        /// <remarks>
        ///     <para>
        ///         <b>Use cases:</b> Cyberpunk, retro-tech, or horror-themed UIs, game splash screens, and any creative context
        ///         where an intentional digital-corruption aesthetic is desired.
        ///     </para>
        ///     <para>
        ///         <b>How it works:</b> Sets the CSS variable <c>--eb-glitch-size</c> and adds the class
        ///         <c>eb-image-effect-glitch</c> to the media wrapper via <c>GlitchEffect.css</c>. The animation runs continuously
        ///         using keyframe-based offset transforms for red, green, and blue pseudo-layers.
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> Pairs well with <c>ColorFlickerEffect</c> for an aggressive corrupted-signal look. Avoid
        ///         combining with <c>DistortEffect</c> or <c>FlipEffect</c> as simultaneous geometric transforms will produce an
        ///         uncontrolled visual result.
        ///     </para>
        ///     <para>
        ///         <b>Tips:</b> Keep <paramref name="size" /> between 2 and 6px for a readable image with glitch accents. Values
        ///         above 10px produce a heavily fragmented image where the content becomes secondary to the effect — intentional
        ///         only for purely decorative uses.
        ///     </para>
        ///     <para>
        ///         <b>Example:</b>
        ///         <code>
