...
// DMBBootstrapBuilder.csproj FireflyEffect_SectionExtensions.cs create at 2026/04/21
...
namespace DMBEffectBuilder
{
    ...
    public static class FireflyEffect_SectionExtensions
    {
        ...
        /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="count"/> or <paramref name="size"/> is less than or equal to 0.</exception>
        /// <remarks>
        /// <para>
        ...
        [Documented]
        public static SectionBuilder FireflyEffect(this SectionBuilder section,
            string color = "#aaff88",
            int count = 20,
            decimal size = 3m)
        {
