...
// DMBBootstrapBuilder.csproj LavaLampEffect_SectionExtensions.cs create at 2026/04/17
...
namespace DMBEffectBuilder
{
    ...
    public static class LavaLampEffect_SectionExtensions
    {
        ...
        /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="count"/> is less than or equal to 0, or <paramref name="blur"/> is negative.</exception>
        /// <remarks>
        /// <para>
