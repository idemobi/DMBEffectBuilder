...
// DMBBootstrapBuilder.csproj ZoomPanEffect_SectionExtensions.cs create at 2026/04/21
...
{
    /// <summary>
    /// Provides extension methods to apply a slow Ken Burns zoom-and-pan background animation to a <see cref="SectionBuilder"/>.
    /// </summary>
    public static class ZoomPanEffect_SectionExtensions
    {
        ...
        [Documented]
        public static SectionBuilder ZoomPanEffect(this SectionBuilder section,
            string imageUrl,
