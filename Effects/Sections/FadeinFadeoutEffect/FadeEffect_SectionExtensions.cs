...
// DMBBootstrapBuilder.csproj FadeEffect_SectionExtensions.cs create at 2026/04/07 21:04:27
...
{
    /// <summary>
    /// Provides extension methods to apply a scroll-driven fade-in/fade-out background image effect to a <see cref="SectionBuilder"/>.
    /// </summary>
    public static class FadeEffect_SectionExtensions
    {
        ...
        /// <param name="scale">Additional scale factor applied to the image (0–1). Use <c>0</c> for no scaling. Defaults to <c>0</c>.</param>
