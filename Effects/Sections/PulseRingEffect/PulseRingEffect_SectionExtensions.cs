...
// DMBBootstrapBuilder.csproj PulseRingEffect_SectionExtensions.cs create at 2026/04/21
...
namespace DMBEffectBuilder
{
    ...
    public static class PulseRingEffect_SectionExtensions
    {
        ...
        /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="count"/> or <paramref name="speedSeconds"/> is less than or equal to 0, or <paramref name="opacity"/> is not between 0 and 1.</exception>
        /// <remarks>
        /// <para>
        ...
        [Documented]
        public static SectionBuilder PulseRingEffect(this SectionBuilder section,
            string color = "#ffffff",
