...
// DMBBootstrapBuilder.csproj MatrixEffect_SectionExtensions.cs create at 2026/04/21
...
namespace DMBEffectBuilder
{
    ...
    public static class MatrixEffect_SectionExtensions
    {
        ...
        /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="fontSize"/> or <paramref name="speed"/> is less than or equal to 0.</exception>
        /// <remarks>
        /// <para>
        ...
        [Documented]
        public static SectionBuilder MatrixEffect(this SectionBuilder section,
            string color = "#00ff41",
            int fontSize = 14,
            decimal speed = 1m)
        {
