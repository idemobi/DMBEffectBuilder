...
// DMBBootstrapBuilder.csproj StarfieldEffect_SectionExtensions.cs create at 2026/04/21
...
namespace DMBEffectBuilder
{
    ...
    public static class StarfieldEffect_SectionExtensions
    {
        ...
        [Documented]
        public static SectionBuilder StarfieldEffect(this SectionBuilder section,
            string color = "#ffffff",
            int count = 120,
            decimal speed = 1.5m)
        {
