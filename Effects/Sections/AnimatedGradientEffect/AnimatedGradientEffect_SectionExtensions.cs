...
// DMBBootstrapBuilder.csproj AnimatedGradientEffect_SectionExtensions.cs create at 2026/04/07 21:04:27
...
namespace DMBEffectBuilder
{
    ...
    public static class AnimatedGradientEffect_SectionExtensions
    {
        ...
        /// <exception cref="ArgumentException">Thrown when <paramref name="colorStart"/> or <paramref name="colorEnd"/> is null or empty.</exception>
        /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="durationSeconds"/> is less than or equal to 0.</exception>
        /// <remarks>
        /// <para>
