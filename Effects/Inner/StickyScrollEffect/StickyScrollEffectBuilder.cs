...
// DMBEffectBuilder.csproj StickyScrollEffectBuilder.cs create at 2026/05/06
...
namespace DMBEffectBuilder
{
    ...
    public sealed class StickyScrollEffectBuilder : IHtmlContent
    {
        ...
        /// <remarks>
        /// <para>
        /// <b>Use cases:</b> programmatically built visuals, server-rendered partials, or content produced outside a Razor view.
        /// </para>
        /// <para>
        /// <b>Combinations:</b> prefer the <see cref="AddStep(Func{dynamic,IHtmlContent},string,string,string)"/> overload
        ...
        /// <summary>Adds a step using a Razor template delegate as the visual panel — the preferred overload in <c>.cshtml</c> views.</summary>
        /// <param name="template">Razor template delegate (<c>@&lt;div&gt;...&lt;/div&gt;</c>) producing the HTML for the sticky panel.</param>
        /// <param name="title">Short heading displayed above the description on the right side.</param>
        /// <param name="description">Body text explaining the step, displayed below the title.</param>
        /// <param name="icon">Optional Bootstrap icon class (e.g. <c>bi-lightning-charge</c>) rendered above the title.</param>
        /// <returns>The current builder instance for chaining.</returns>
        ...
        /// </summary>
        /// <param name="icon">Bootstrap icon class shown in both the visual panel and the right-side step header, e.g. <c>"bi-lightning-charge"</c>.</param>
        ...
        public StickyScrollEffectBuilder AddStep(
            string icon, string visualLabel, string title, string description,
        ...
        /// <remarks>
        /// <para>
        /// <b>Use cases:</b> match this value to the height of your fixed navbar so the sticky panel never slides underneath it.
        /// </para>
        /// <para>
        ...
        public void WriteTo(TextWriter writer, HtmlEncoder encoder)
        {
            ...
            for (int i = 0; i < _steps.Count; i++)
            {
                ...
                if (!string.IsNullOrEmpty(step.Icon))
                    writer.Write($"<div class=\"eb-ss-icon\"><i class=\"bi {HtmlEncoder.Default.Encode(step.Icon)}\"></i></div>");
