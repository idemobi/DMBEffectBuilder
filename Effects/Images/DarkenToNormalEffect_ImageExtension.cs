...
namespace DMBEffectBuilder
{
    ...
    public static class DarkenToNormalEffect_ImageExtension
    {
        ...
        /// <summary>
        ///     Renders the image at a reduced brightness on load and transitions it to full normal brightness, creating a
        ...
        /// <remarks>
        ///     <para>
        ///         <b>Use cases:</b> Hero banners, portfolio thumbnails, or product images where a fade-in-from-dark entrance
        ///         adds cinematic weight to page load or scroll-into-view moments.
        ///     </para>
        ///     <para>
        ///         <b>How it works:</b> Sets the CSS variable <c>--eb-image-effect-brightness</c> and adds the class
        ///         <c>eb-image-effect-darken-to-normal</c> to the media wrapper via <c>DarkenToNormalEffect.css</c>. The
        ///         transition plays once on load.
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> Works well alongside <c>FocusSpotEffect</c> to draw the eye after the reveal. Avoid
        ///         combining with <c>GhostEffect</c> as both lower perceived brightness and the result will appear too muted.
        ///     </para>
        ///     <para>
        ///         <b>Tips:</b> Values between 0.3 and 0.6 for <paramref name="brightness" /> give a noticeable but not extreme
        ///         darkening. Avoid values below 0.2 on images with fine detail as it obscures too much at load time.
        ///     </para>
        ///     <para>
        ///         <b>Example:</b>
        ///         <code>
