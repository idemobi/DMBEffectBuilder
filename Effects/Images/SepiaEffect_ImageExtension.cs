...
namespace DMBEffectBuilder
{
    ...
    public static class SepiaEffect_ImageExtension
    {
        ...
        /// <summary>
        ///     Applies a CSS sepia filter to the image, with independent intensity and contrast values for rest and hover
        ///     states.
        /// </summary>
        ...
        ///     Sepia intensity on hover as a percentage (0–100); default 100 — fully desaturated to warm
        ///     brown on hover.
        /// </param>
        ...
        /// <remarks>
        ///     <para>
        ///         <b>Use cases:</b> Portfolio thumbnails that reveal color on hover, historical or archival image galleries,
        ///         hero images with a muted-by-default tone, or any context where you want color to feel like a reward for
        ///         interaction.
        ///     </para>
        ///     <para>
        ///         <b>How it works:</b> Sets CSS variables <c>--eb-image-effect-sepia</c>, <c>--eb-image-effect-hover-sepia</c>,
        ///         <c>--eb-image-effect-contrast</c>, and <c>--eb-image-effect-hover-contrast</c> on the image element, then wraps
        ///         it in a media component with class <c>eb-image-effect-sepia</c> (SepiaEffect.css). Transition timing is defined
        ///         in the stylesheet.
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> Pairs naturally with <c>ZoomHoverEffect</c> for a combined "color-and-zoom" reveal.
        ///         <c>VignetteEffect</c> adds mood when <c>amount</c> is non-zero. Avoid combining with <c>SepiaToColorEffect</c>
        ///         — they control the same CSS variables.
        ///     </para>
        ///     <para>
        ///         <b>Tips:</b> Use <c>amount: 80, hoverAmount: 0</c> to invert the default — sepia at rest, color on hover (a
        ///         more dramatic reveal). Raise <c>hoverContrast</c> to 1.3–1.4 to make colors pop vividly on hover. Keep
        ///         <c>amount: 0</c> (default) for the subtle "color unlocks on hover" pattern that works on image grids.
        ///     </para>
        ///     <para>
        ///         <b>Example:</b>
        ///         <code>
