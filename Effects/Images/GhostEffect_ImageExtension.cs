...
namespace DMBEffectBuilder
{
    ...
    public static class GhostEffect_ImageExtension
    {
        ...
        /// <summary>
        ///     Renders the image with a persistent semi-transparent, blurred appearance that gives it a ghostly, ethereal
        ///     look.
        /// </summary>
        ...
        /// <param name="unit">
        ///     The unit of measurement for the <paramref name="blur" /> radius. Defaults to
        ///     <see cref="UnitSize.px" />.
        /// </param>
        /// <returns>The modified <see cref="ImageRenderBuilder" /> instance with the effect applied.</returns>
        /// <remarks>
        ///     <para>
        ///         <b>Use cases:</b> Decorative background layers, watermark-style images, disabled-state placeholders, and
        ///         atmospheric UI elements where an image should recede visually without disappearing.
        ///     </para>
        ///     <para>
        ///         <b>How it works:</b> Sets CSS variables <c>--eb-ghost-opacity</c> and <c>--eb-ghost-blur</c>, then adds the
        ///         class <c>eb-image-effect-ghost</c> to the media wrapper via <c>GhostEffect.css</c>. The effect is always-on,
        ///         not hover-triggered.
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> Combines well with <c>ColorFlickerEffect</c> to create a ghostly pulsing animation.
        ///         Avoid combining with <c>FadeHoverEffect</c> or <c>FocusSpotEffect</c> as they also manipulate opacity and the
        ///         values will conflict.
        ///     </para>
        ///     <para>
        ///         <b>Tips:</b> Use <paramref name="opacity" /> between 0.1 and 0.3 for a true ghost effect; higher values
        ///         simply produce a blurred image without the translucent feel. Increasing <paramref name="blur" /> beyond 8px may
        ///         render fine-detail images unrecognisable.
        ///     </para>
        ///     <para>
        ///         <b>Example:</b>
        ///         <code>
