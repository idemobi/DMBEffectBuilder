...
namespace DMBEffectBuilder
{
    ...
    public static class BlurToSharpEffect_ImageExtension
    {
        ...
        /// <remarks>
        ///     <para>
        ///         <b>Use cases:</b> Hero images, article thumbnails, or gallery items where a soft focus-pull entrance
        ///         adds polish. Works especially well when the image loads lazily — the blur fills the placeholder visually
        ///         before the full resolution arrives.
        ///     </para>
        ///     <para>
        ///         <b>How it works:</b> Sets the CSS custom property <c>--eb-image-effect-blur</c> to the specified
        ...
        ///     </para>
        ///     <para>
        ///         <b>Combinations:</b> Pairs well with <c>DarkenToNormalEffect</c> for a cinematic reveal. Avoid
        ///         combining with <c>GlitchEffect</c> or <c>ColorFlickerEffect</c> as the competing animations clash
        ///         visually.
        ///     </para>
        ///     <para>
        ///         <b>Tips:</b> Keep <paramref name="blur" /> between 2px and 8px for a subtle entrance; values above
